...
#[post("/blog")]
async fn create_blogpost(data: web::Data<MySqlPool>,new_post: web::Json<NewBlogPost>) -> Result<impl Responder, ApiError> {
...
#[get("/blog")]
async fn get_all_blogposts(data: web::Data<MySqlPool>) -> Result<impl Responder, ApiError> {
...
#[get("/blog/{id}")]
async fn read_blogpost(data: web::Data<MySqlPool>,path: web::Path<i32>) -> Result<impl Responder, ApiError> {
...
#[delete("/blog/{id}")]
async fn delete_blogpost(data: web::Data<MySqlPool>,path: web::Path<i32>) -> Result<impl Responder, ApiError> {
